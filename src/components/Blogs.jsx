    ...
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-24">
      <div className=" flex flex-col items-center lg:flex-row justify-between">
        <div>
          ...
          Stay updated with the latest insights and trends in healthcare. Our blog features expert advice, health tips, and company news to keep you informed and engaged with your well-being.
          </p>
        </div>
